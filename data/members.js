...
export const members = [
  ...
  },
  {
    ...
    bio: "সংগঠনের প্রচার ও ��্রকাশনা বিভাগ পরিচালনা করেন। সোশ্যাল মিডিয়া ও প্রচারমাধ্যমে সংগঠনের কার্যক্রম তুলে ধরেন।",
    joinedDate: "2023",
    responsibilities: [
  ...
  image: "/images/tanvirur-rohim.jpg",
...
export default members;
  ...
  category: "Active Members",
    ...
    joinedDate: "2023",
    responsibilities: [
      "সংগঠনের ��িদ্ধান্ত বাস্তবায়ন করা",
      "বিভিন্ন কর্মসূচি পরিকল্পনা ও পরিচালনায় অংশগ্রহণ",
      "সদস্যদের সাথে সমন্বয় ও যোগাযোগ রক্ষা",
      "মানবিক ও সামাজিক কার্যক্রমে নেতৃত্ব প্রদান",
      "সংগঠনের সুনাম ও শৃঙ্খলা বজায় রাখা",
